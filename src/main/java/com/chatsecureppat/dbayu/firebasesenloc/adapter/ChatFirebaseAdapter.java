package com.chatsecureppat.dbayu.firebasesenloc.adapter;
...
import com.chatsecureppat.dbayu.firebasesenloc.R;
...
public class ChatFirebaseAdapter extends FirebaseRecyclerAdapter<ChatModel,ChatFirebaseAdapter.MyChatViewHolder> {
    ...
    protected void populateViewHolder(MyChatViewHolder viewHolder, ChatModel model, int position) {
        ...
        if (model.getFile() != null){
            ...
            viewHolder.setIvChatPhoto(com.chatsecureppat.dbayu.firebasesenloc.util.Util.local(model.getMapModel().getLatitude(),model.getMapModel().getLongitude()));
